...
createRestaurantHTML = (restaurant) => {
  ...
  image.src = `/img/${restaurant.photograph}-300px`;
  image.srcset=`/img/${restaurant.photograph}-original 700w, /img/${restaurant.photograph}-480px 400w, /img/${restaurant.photograph}-300px 200w`;
